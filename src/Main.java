...
public class Main {
    public static void main(String[] args) {
        ...
        Pharmacy pharmacy1 = new Pharmacy("<Medicaments>", 10, 3, LocalDate.now());
        Pharmacy pharmacy2 = new Pharmacy("Medicaments2", 4, 99, LocalDate.now());
        Pharmacy pharmacy3 = new Pharmacy("Medicaments3", 7, 58, LocalDate.now());
